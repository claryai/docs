...
For more information on authentication, see the [Authentication](/api-reference/authentication) page.
...
<CardGroup cols={3}>
  <Card title="Python" icon="python">
    ...
    pip install claryai
    ```
    [Documentation](/api-reference/sdks/python)
  </Card>
  <Card title="JavaScript" icon="js">
    ```bash
    npm install claryai
    ```
    [Documentation](/api-reference/sdks/javascript)
  </Card>
  <Card title="Java" icon="java">
    ...
    ```
    [Documentation](/api-reference/sdks/java)
  </Card>
</CardGroup>
