...
For more detailed installation instructions, see the [Installation Guide](/getting-started/installation).
...
- Explore the [API Reference](/api-reference/overview) for more advanced usage
- Learn about [Workflows](/api-reference/endpoints/workflows) for automating document processing
